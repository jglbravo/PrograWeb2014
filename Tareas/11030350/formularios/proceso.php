...
function()
{
  ...
  var c=0,e=0,b=0,f=0;
    ...
    d=parseInt(<?php echo $_POST['dia'];  ?>);

    m=parseInt(<?php echo $_POST['mes'];  ?>); //---> PASAR DE TEXTO A TIPO NUMERICO 
    a=parseInt(<?php echo $_POST['anio'];  ?>); //---> PASAR DE TEXTO A TIPO NUMERICO 
