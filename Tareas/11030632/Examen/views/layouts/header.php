        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="<?php echo BASEURL; ?>/views/11030632/formulariotarea1.php">Datos personales</a></li>
                <li class="divider"></li>
                 <li><a href="<?php echo BASEURL; ?>/views/11030632/formulariotarea2.php">Historial Medico</a></li>
              </ul>
            </li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="<?php echo BASEURL; ?>/views/11030632/tablaregistro.php">Registro</a></li>
              </ul>
            </li>
